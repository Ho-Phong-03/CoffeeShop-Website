        ...
        <div id="content">
            ...
            <div class="main-content">
                ...
                <div class="reviews_stat">
                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            switch ($monthValue) {
                                case 1:
                                    $month_array[0]++;
                                    $average_rating_month_array[0] += $starValue;
                                    break;
                                case 2:
                                    $month_array[1]++;
                                    $average_rating_month_array[1] += $starValue;
                                    break;
                                case 3:
                                    $month_array[2]++;
                                    $average_rating_month_array[2] += $starValue;
                                    break;
                                case 4:
                                    $month_array[3]++;
                                    $average_rating_month_array[3] += $starValue;
                                    break;
                                case 5:
                                    $month_array[4]++;
                                    $average_rating_month_array[4] += $starValue;
                                    break;
                                case 6:
                                    $month_array[5]++;
                                    $average_rating_month_array[5] += $starValue;
                                    break;
                                case 7:
                                    $month_array[6]++;
                                    $average_rating_month_array[6] += $starValue;
                                    break;
                                case 8:
                                    $month_array[7]++;
                                    $average_rating_month_array[7] += $starValue;
                                    break;
                                case 9:
                                    $month_array[8]++;
                                    $average_rating_month_array[8] += $starValue;
                                    break;
                                case 10:
                                    $month_array[9]++;
                                    $average_rating_month_array[9] += $starValue;
                                    break;
                                case 11:
                                    $month_array[10]++;
                                    $average_rating_month_array[10] += $starValue;
                                    break;
                                case 12:
                                    $month_array[11]++;
                                    $average_rating_month_array[1] += $starValue;
                    ...
                    <input type="hidden" id="hidden-year" value=<?php echo isset($values[2]) ? $values[2] : "N/A"; ?> />
